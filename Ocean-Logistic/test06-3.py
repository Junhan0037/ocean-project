...
"""
    ...
    수온, 염분, 용존산소, 인산염인, 아질산질소, 질산규소, 규산수소 로지스틱 회귀분석
"""
...
def logistic_Temperature_Salinity_Oxygen_Phosphorus_Nitrous_Nitric_Silicon (input_file, output_file):
    ...
    data = {'Observation Date':data_frame['Observation Date'], 'Temperature': temp_list, 'Salinity':sal_list, 'Dissolved Oxygen':oxy_list, 'Phosphate Phosphorus': Phosphate_list, 'Nitrous Acid Nitrogen':Nitrous_list, 'Nitric Acid Nitrogen':Nitric_list, 'Silicic Acid Silicon':Silicic_list, 'On/Off':data_frame['On/Off'], 'Probability':at_means_list}
...
if __name__ == "__main__":
    ...
    # 함수호출 (입력파일명, 출력파일명)
    logistic_Temperature_Salinity_Oxygen_Phosphorus_Nitrous_Nitric_Silicon('add_on_off_eng.csv', 'logistic_3.csv')