...
def west_ocean(input_file, output_file):
    
    # 파일 불러오기
    data_frame = pd.read_csv(input_file, index_col = None, encoding='cp949')
    
    # 해역별로 구분하는 데이터 프레임
    Sea_area_df = data_frame[data_frame.loc[:,'Sea_area']=='서해']
...
if __name__ == "__main__":
    ...
    west_ocean('filtering_data_month.csv', 'west_ocean.csv')