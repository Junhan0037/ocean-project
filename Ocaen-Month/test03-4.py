...
def phosphorus_graph(input_file1, input_file2, input_file3, input_file4, output_file):
    ...
    plt.figure(figsize=(20,8))
    plt.boxplot((data_frame.loc[data_frame['Observation Date']==1, 'Phosphate Phosphorus'].dropna(), 
                 data_frame.loc[data_frame['Observation Date']==2, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==3, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==4, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==5, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==6, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==7, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==8, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==9, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==10, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==11, 'Phosphate Phosphorus'].dropna(),
                 data_frame.loc[data_frame['Observation Date']==12, 'Phosphate Phosphorus'].dropna()))
    plt.xlabel('Month')
    plt.ylabel('Phosphate Phosphorus')
    plt.title('Sea area Phosphate Phosphorus')
    plt.show()
...
if __name__ == "__main__":
    ...
    phosphorus_graph('east_ocean.csv', 'south_ocean.csv', 'west_ocean.csv', 'east_china_ocean.csv', 'ocean_month.csv')