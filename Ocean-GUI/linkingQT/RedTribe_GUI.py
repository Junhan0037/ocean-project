...
class MainGUI(QtWidgets.QMainWindow, Ui_Dialog):
    ...
    def onePageSearchpushButton(self):
        ...
        print(self.NitricAcidNitrogenlineEdit.text()) #1page 질산규소
